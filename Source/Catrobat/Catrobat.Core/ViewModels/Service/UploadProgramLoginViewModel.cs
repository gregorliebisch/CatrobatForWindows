...
namespace Catrobat.IDE.Core.ViewModels.Service
{
  public class UploadProgramLoginViewModel : ViewModelBase
  {
    ...
    public RelayCommand LoginCommand => new RelayCommand(LoginAction);

    public RelayCommand ForgottenCommand => new RelayCommand(ForgottenAction);

    public RelayCommand RegisterCommand => new RelayCommand(RegisterAction);
    ...
    private async void LoginAction()
    {
      ...
      else
      {
        ...
        switch (statusResponse.statusCode)
        {
          ...
          default:
            string messageString = string.IsNullOrEmpty(statusResponse.answer) ? string.Format(AppResourcesHelper.Get("Main_UploadProgramUndefinedError"), statusResponse.statusCode) :
